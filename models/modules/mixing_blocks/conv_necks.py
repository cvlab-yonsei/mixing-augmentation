...
class ConvNeck(nn.Module):
    def __init__(
        ...
        num_layers=2, kernel_size=1, stride=1, conv_cfg=None, norm_cfg=dict(type='BN', requires_grad=True),
        act_cfg=dict(type='ELU'), conv_depthwise=False, with_bias=False, with_avg_pool=False,
        with_last_norm=False, with_last_dropout=0., with_residual=False, with_pixel_shuffle=False,
